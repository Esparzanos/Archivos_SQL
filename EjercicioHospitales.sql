...
VALUES 
	...
	(20, 'Clinica San Juan', 2),
	(30, 'Centro Medico Norte', 3),
	(40, 'Hospital Santa Maria', 1),
	(50, 'Clinica San Lucas', 2)
GO
...
VALUES
	...
	(1002, '2022-09-06', 65, 118, 168, 'Revision de rutina', 102),
...
SELECT CLAVE =1, NOMBRE = 'ENERO' UNION
...
SELECT  M.NOMBRE AS MES,
        ISNULL(COUNT(VC.CITA), 0) AS NUMCITAS
FROM VW_MESES M
LEFT JOIN VW_CITAS VC ON M.CLAVE = MONTH(VC.FECHA)
GROUP BY M.NOMBRE, M.CLAVE
ORDER BY M.CLAVE
GO
